...
static const uint8_t sio_stub[] = {
    ...
    
};
static const uint8_t rst_stub[] = {
    0xa9,0x00,0x8d,0x3d,0x03,0x8d,0x3e,0x03,0x8d,0x3f,0x03,0x4c,0xff,0xff
};
...
void xl_sio_service(volatile uint8_t *page)
{
    ...
    case 0x50: case 0x57: {                         /* PUT / WRITE sector */
        if (dbuf >= 0x4000 && dbuf <= 0x5FFF) {     /* staged through the overlay
                                                     * the stub itself maps: the
                                                     * documented v1 gap */
            klog("[xl] SIO write from $4000-$5FFF refused (v1)\r\n");
            st = 0x90; break;
        }
        uint32_t off, l = atr_sector(d, daux, &off);
        if (!l) { st = 0x90; break; }
        if (dbyt && dbyt < l) l = dbyt;
        memcpy(d->img + off, (const uint8_t *)data, l);   /* RAM image only (v1) */
        break;
    }
    default:
        st = 0x8B;                                  /* device NAK */
