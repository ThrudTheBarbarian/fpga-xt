# Pin map — fpga-xt on Z-Turn Z7-Lite (XC7Z020-2CLG400)

Pin assignments for the MYiR Z-Turn Z7-Lite SOM (Zynq-7020,
xc7z020clg400-2).  Authoritative source is
[`vivado/constraints/zturn_board.xdc`](../vivado/constraints/zturn_board.xdc);
...
- `clk_pix`   (148.4375 MHz) — `fb_scanout` → SiI9022A
