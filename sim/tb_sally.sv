// tb_sally.sv — M24-1 xt6502 core bring-up.
//
// Drives the xt6502 NMOS 6502 core against a flat 64 KB BRAM holding
// hand-assembled test programs. Verifies fundamental instruction
// execution: LDA/LDX/LDY immediate + ZP + ABS, STA/STX/STY,
...
// returns data the next) — matches the xt6502 synchronous-memory contract.
...
`endif
    ...
    initial begin
        ...
        // 65C02 fixes this. xt6502 models NMOS, so we expect the bug.
        //
        // Vector layout:
        //   $02FF = $34   (target low)
        ...
        begin
            ...
            if (writes_at_target == 2) begin
                ...
                $display("[H.2] DIVERGENCE — single-write RMW. Tracked as");
