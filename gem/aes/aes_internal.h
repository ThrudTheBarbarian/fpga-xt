...
void     wind_plane_box(int hd,int x,int y,int w,int h);  /* M6: the plane's SCREEN box — the
                                         * alpha hole is punched HERE, not over the whole work
                                         * area, so a smaller picture letterboxes in app pixels */
