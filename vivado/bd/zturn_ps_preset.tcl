# zturn_ps_preset.tcl — AUTO-EXTRACTED board-physical PS config.
#
# Source: MyIR Z-Turn hdmi-1080p reference design
#   (zturn-7z020/hdmi-1080p .../hw_handoff/hdmi_out_bd.tcl, processing_system7 5.5).
# This is the EXACT PS config whose BOOT.bin was confirmed to boot DDR +
# UART + HDMI on the real V2 board (2026-05-29), so it is used verbatim —
# including DDR PARTNO MT41J256M16 + board-delay/DQS values — even though the
# V2 schematic marks the fitted die MT41K256M16HA-125:E (pin/timing-compatible;
# the proven config wins over the part-number match).
#
# PL-interface / EMIO / FCLK / I2C0 / TTC0 keys are intentionally STRIPPED —
# gen_ps_bd.tcl owns those (HP0/1/3, GP0@150MHz, no EMIO/CLK1, I2C0/TTC0 off)
# so the ps_bd port set keeps matching fpga_xt_top.
#
# Requires $ps (the processing_system7 bd cell) to be set by the caller.
...
set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#reset#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#scl#sda#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#cd#wp#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
