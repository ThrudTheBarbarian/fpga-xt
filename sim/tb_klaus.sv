// tb_klaus.sv — Klaus Dormann 6502 functional test against the xt6502 clean-sheet core.
//
...
// $0400 in the testbench so the CPU actually starts the test.
//
// Memory model: a flat 64 KB BRAM driven directly by xt6502. We
...
module tb_klaus;
    ...
    // Klaus's test takes ~96 million 6502 cycles. The core uses
