...
- `fpga-xtc/docs/Design/threading.md` — the language surface, the ARC decision,
  and §5, the requirements this implements.
- [memory-protection.md](memory-protection.md) — the per-process address spaces
  thread stacks are carved from.
- [dynamic-loading.md](dynamic-loading.md) — the loader and the syscall ABI.
