...
module edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    input  vio0_p0_ShiftCtrl_en,
    input  [5:0] vio0_p1_PLL_Shift,
    input  [2:0] vio0_p2_Status,
    input  [28:0] vio0_p3_Freq,
    input  [10:0] vio0_p4_Window_Lock,
    output vio0_s0_Mode,
    output vio0_s1_ShiftCtrl_en,
    output [2:0] vio0_s2_PLL_Shift
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 5 ),
        .NUM_PROBE_OUT          ( 3 ),
        .UUID           ( 128'h268bbc21b7014e3481e9c8316d5c1e0c ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_IN1_WIDTH        ( 6 ),
        .PROBE_IN2_WIDTH        ( 3 ),
        .PROBE_IN3_WIDTH        ( 29 ),
        ...
        .clk                ( vio0_clk ),
        .probe_in0          ( vio0_p0_ShiftCtrl_en ),
        .probe_in1          ( vio0_p1_PLL_Shift ),
        .probe_in2          ( vio0_p2_Status ),
        .probe_in3          ( vio0_p3_Freq ),
        .probe_in4          ( vio0_p4_Window_Lock ),
        .probe_in5          ( 1'b0 ),
        .probe_in6          ( 1'b0 ),
        .probe_in7          ( 1'b0 ),
        .probe_in8          ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_s0_Mode ),
        .probe_out1         ( vio0_s1_ShiftCtrl_en ),
        .probe_out2         ( vio0_s2_PLL_Shift ),
        .probe_out3         (  ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
